...
export const BLUEPRINTS: Record<string, Blueprint> = {
  ...
  services: {
    ...
    titlePattern: "Services | {business_name}",
    metaDescriptionMaxChars: 155,
    minWords: 300,
  },
  service: {
  ...
  about: {
    ...
    schema: ["{localBusinessSchema}", "BreadcrumbList"],
    titlePattern: "About us | {business_name}",
    metaDescriptionMaxChars: 155,
    minWords: 300,
  },
  team: {
  ...
  location: {
    ...
    schema: ["{localBusinessSchema}", "BreadcrumbList"],
    titlePattern: "Location & directions | {business_name}",
    metaDescriptionMaxChars: 155,
    minWords: 200,
  },
  contact: {
  ...
  faq: {
    ...
    titlePattern: "Frequently asked questions | {business_name}",
    metaDescriptionMaxChars: 155,
    minWords: 250,
  },
  "blog-index": {
  ...
  privacy: {
    ...
    schema: ["BreadcrumbList"],
    titlePattern: "Privacy policy | {business_name}",
    metaDescriptionMaxChars: 155,
    minWords: 100,
    isUtility: true,
  },
  cookies: {
    ...
    requiredSections: ["rich-text"],
    schema: ["BreadcrumbList"],
    titlePattern: "Cookie policy | {business_name}",
    metaDescriptionMaxChars: 155,
    minWords: 80,
    isUtility: true,
  },
  terms: {
    ...
    requiredSections: ["rich-text"],
    schema: ["BreadcrumbList"],
    titlePattern: "Terms & conditions | {business_name}",
    metaDescriptionMaxChars: 155,
    minWords: 80,
    isUtility: true,
  },
  "404": {
    ...
    schema: [],
    titlePattern: "Page not found | {business_name}",
    metaDescriptionMaxChars: 155,
    minWords: 30,
    isUtility: true,
  },
